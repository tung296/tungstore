								...
								<div class="col-sm-3 mb-2">
									<div class="single-item">
										<div class="single-item-header">
											<a class="new_product-image" href="{{route('product_detail',$product->id)}}"><img src="{{ URL::asset('storage/'.$product->images) }}" alt=""></a>
										</div>
										...
										<div class="single-item-caption">
											...
											<a class="beta-btn primary" href="{{route('product_detail',$product->id)}}">Details <i class="fa fa-chevron-right"></i></a>
											<div class="clearfix"></div>
										</div>
									</div>
								</div>
