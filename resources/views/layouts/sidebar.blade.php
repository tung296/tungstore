    ...
    <div id="sidebar-scrollbar">
       <nav class="iq-sidebar-menu">
          <ul id="iq-sidebar-toggle" class="iq-menu">
             ...
             <li>
                <a href="#permissioninfo" class="iq-waves-effect" data-toggle="collapse" aria-expanded="false"><span class="ripple rippleEffect"></span><i class="lab la-elementor iq-arrow-left"></i><span>Permission</span><i class="ri-arrow-right-s-line iq-arrow-right"></i></a>
                <ul id="permissioninfo" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle" style="">
                  @can('permission-create')
                   <li><a href="{{ route('permissions.create') }}"><i class="las la-plus-circle"></i>Permission Add</a></li>
                   @endcan
                   @can('permission-list')
                   <li><a href="{{ route('permissions.index') }}"><i class="las la-th-list"></i>Permission List</a></li>
                   @endcan
                </ul>
             </li> 
             <li>
                ...
                <ul id="roleinfo" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle" style="">
                  @can('role-create')
                   <li><a href="{{ route('roles.create') }}"><i class="las la-plus-circle"></i>Role Add</a></li>
                   @endcan
                   @can('role-list')
                   <li><a href="{{ route('roles.index') }}"><i class="las la-th-list"></i>Role List</a></li>
                   @endcan
                </ul>
             </li>
             <li>
        ...
        @endcan
             ...
             <!-- <li>
                <a href="#trackinginfo" class="iq-waves-effect" data-toggle="collapse" aria-expanded="false"><span class="ripple rippleEffect"></span><i class="lab la-elementor iq-arrow-left"></i><span>Tracking</span><i class="ri-arrow-right-s-line iq-arrow-right"></i></a>
                <ul id="trackinginfo" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle" style="">
                  @can('tracking-list')
                   <li><a href="{{ route('trackings.index') }}"><i class="las la-th-list"></i>Traking List</a></li>
                   @endcan
                </ul>
             </li> -->
             <!-- <li>
